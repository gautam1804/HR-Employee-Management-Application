...
titleLabel.setBounds(lm+110+5+10+10,tm+20,400,30);
titleTextField.setBounds(lm+10+110+5,tm+20,350,30);
clearTitleTextFieldButton.setBounds(lm+110+10+5+350+5,tm+20,30,30);
...
JOptionPane.showMessageDialog(DesignationUI.this,"PDF file created");
}
});
}
